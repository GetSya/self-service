...
const jadibot = async (client, text, m, from) => {
...
let { version, isLatest } = await fetchLatestBaileysVersion();
 ...
 const client = simple.makeWASocket(config)   
...
require('./sya.js')(client, m, chatUpdate, store)
} catch (err) {
console.log(err)}
})
...
console.log(`clientce Logged Out, Please Scan Again And Run.`); client.logout(); }
